...
String baseUrlOnEnviroment(APIEnviroment enviroment) {
  return switch (enviroment) {
    APIEnviroment.PROD => "https://api.jikan.moe/v4",
  };
}

// Dio's Third-Party Plugins (https://github.com/cfug/dio/issues/347)
class JikanApiProvider {
  final Dio dio = Dio();

  Ref ref;
  SecureStorage secureStorage;

  JikanApiProvider({required this.ref, required this.secureStorage}) {
    // Basic Config
...
final jikanApiProvider = Provider<JikanApiProvider>(
  (ref) => JikanApiProvider(
    ref: ref,
